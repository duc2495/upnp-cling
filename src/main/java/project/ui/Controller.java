...
public class Controller extends javax.swing.JFrame {
	...
	public Controller(AirConditional airConditional) {
		...
		controllerSpeedMiddleLabel.setText((ChangeSpeed.MIN_SPEED + ChangeSpeed.MAX_SPEED) / 2 + Unit.speedUnit);
	...
	private void setLimitControllerWindSlider() {
		...
		controllerDirectionSlider.setValue((ChangeDirection.MIN_DIRECTION + ChangeDirection.MAX_DIRECTION) / 2);
	}
	...
	private void controllerTempSliderStateChanged(javax.swing.event.ChangeEvent evt) {
		...
		controllerTempLabel.setText(Unit.temperatureLabel + " (" + String.valueOf(currentTemp) + Unit.tempUnit + "): ");
		if (isOn)
	...
	private void controllerSpeedSliderStateChanged(javax.swing.event.ChangeEvent evt) {
		...
		controllerSpeedLabel.setText(Unit.speedLabel + " (" + String.valueOf(currentSpeed) + Unit.speedUnit + "): ");
		if (isOn)
	...
	private void controllerStateCheckboxStateChanged(ActionEvent evt) {
		this.callService("AirConditional", "SwitchPower", "Set", "Status", controllerStateCheckbox.isSelected());
	}
	...
	private void initComponents() {
				...
				.addGroup(controllerPanelLayout.createSequentialGroup().addGap(26, 26, 26)
						.addGroup(controllerPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								...
								.addGroup(controllerPanelLayout.createSequentialGroup()
										.addGroup(controllerPanelLayout
												...
												.addGroup(controllerPanelLayout.createSequentialGroup().addGap(2, 2, 2)
														.addComponent(controllerStateLabel,
						...
						.addGroup(controllerPanelLayout
								...
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
										controllerPanelLayout.createSequentialGroup()
												.addComponent(controllerTempLeftLabel).addGap(159, 159, 159)
												.addComponent(controllerTempMiddleLabel).addGap(158, 158, 158)
		...
		controllerPanelLayout.setVerticalGroup(controllerPanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(controllerPanelLayout.createSequentialGroup().addGap(28, 28, 28)
						...
						.addGroup(controllerPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(controllerPanelLayout.createSequentialGroup()
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(controllerTempLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 33,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addGap(16, 16, 16))
		...
		layout.setHorizontalGroup(
				layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(controllerPanel,
